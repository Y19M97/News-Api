...
myHttp.open('GET', `https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=fa466f364d20453b9a45f6df6839953f`)
myHttp.send()
...
function display(){
    ...
    for(i=0 ; i < all.length; i++){
        all[i].urlToImage !==null && all[i].title !==null ?
        box+=`
    <div class="col-md-4">
